...
show_final_instructions() {
    if supports_color; then
        ...
        printf "\n\033[1;34m3. Set up AstroNvim (requires SSH keys for GitHub):\033[0m\n"
        printf "   \033[32mbash ./setup-astronvim.sh\033[0m\n"
        printf "\n\033[1;34m4. Configure Claude Code (installed with post-setup.sh):\033[0m\n"
        printf "   \033[32mclaude auth login\033[0m\n"
        printf "\n\033[1;34m5. Set up Claude Code workflow system:\033[0m\n"
        printf "   \033[32mcd ~/.dotfiles/claude && ./setup.sh\033[0m\n"
        printf "\n\033[1;34m6. Change default shell to bash (recommended for tmux/kitty):\033[0m\n"
        printf "   \033[32m./change-shell.sh\033[0m\n"
        printf "\n\033[1;34m7. If using zsh (and configurations not auto-added), add to ~/.zshrc:\033[0m\n"
        printf "   \033[32meval \"\$(/opt/homebrew/bin/brew shellenv)\"\033[0m\n"
        printf "   \033[32msource ~/.bash_profile\033[0m\n"
        printf "\n\033[1;34m8. Launch applications:\033[0m\n"
        ...
        echo "   bash ./post-setup.sh"
        echo ""
        echo "3. Set up AstroNvim (requires SSH keys for GitHub):"
        echo "   bash ./setup-astronvim.sh"
        echo ""
        echo "4. Configure Claude Code (installed with post-setup.sh):"
        echo "   claude auth login"
        echo ""
        echo "5. Set up Claude Code workflow system:"
        echo "   cd ~/.dotfiles/claude && ./setup.sh"
        echo ""
        echo "6. Change default shell to bash (recommended for tmux/kitty):"
        echo "   ./change-shell.sh"
        echo ""
        echo "7. If using zsh (and configurations not auto-added), add to ~/.zshrc:"
        echo "   eval \"\$(/opt/homebrew/bin/brew shellenv)\""
        echo "   source ~/.bash_profile"
        echo ""
        echo "8. Launch applications:"
