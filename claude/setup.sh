...
echo "Done."
echo ""
echo "Skills:  /setup, /sketch, /spec, /issue, /dispatch, /pr"
echo "Agent:   runner"
echo ""
echo "Workflow (sketch — local):"
echo "  /setup                           — init project (CLAUDE.md, git, hooks, deps)"
echo "  /sketch jwt-auth                 — flesh out a feature"
echo "  /dispatch jwt-auth               — spawn runner from sketch"
echo "  /dispatch status                 — check progress"
echo ""
echo "Workflow (Linear):"
echo "  /spec                            — conversation → Linear spec + sub-issues"
