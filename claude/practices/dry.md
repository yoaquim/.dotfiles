...
Superseding something means it dies in the same PR — code, exports, and its tests.

- **A test suite is not a consumer.** "Its tests still pass" is not a reason to keep dead code — it is the mechanism by which dead code survives, warm enough that someone imports it by accident.
