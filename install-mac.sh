...
show_final_instructions() {
    if supports_color; then
        ...
        printf "\n\033[1;34m4. Set up Claude Code workflow system:\033[0m\n"
        printf "   \033[32mcd ~/.dotfiles/claude && ./setup.sh\033[0m\n"
        printf "\n\033[1;34m5. Change default shell to bash (recommended for tmux/kitty):\033[0m\n"
        printf "   \033[32m./change-shell.sh\033[0m\n"
        printf "\n\033[1;34m6. If using zsh (and configurations not auto-added), add to ~/.zshrc:\033[0m\n"
        printf "   \033[32meval \"\$(/opt/homebrew/bin/brew shellenv)\"\033[0m\n"
        printf "   \033[32msource ~/.bash_profile\033[0m\n"
        printf "\n\033[1;34m7. Launch applications:\033[0m\n"
        ...
        echo ""
        echo "4. Set up Claude Code workflow system:"
        echo "   cd ~/.dotfiles/claude && ./setup.sh"
        echo ""
        echo "5. Change default shell to bash (recommended for tmux/kitty):"
        echo "   ./change-shell.sh"
        echo ""
        echo "6. If using zsh (and configurations not auto-added), add to ~/.zshrc:"
        echo "   eval \"\$(/opt/homebrew/bin/brew shellenv)\""
        echo "   source ~/.bash_profile"
        echo ""
        echo "7. Launch applications:"
